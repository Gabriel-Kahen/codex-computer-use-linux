...
TOOLS = [
    ...
    tool("save_session_window_capture", "Capture one mapped X11 window and atomically create or replace an absolute PNG path. Also returns the PNG inline.", {**WINDOW, **CLAIM_TOKEN, "save_path": {"type": "string", "minLength": 1, "maxLength": 4096}}, ["window", "save_path"], idempotent=True, open_world=False),
