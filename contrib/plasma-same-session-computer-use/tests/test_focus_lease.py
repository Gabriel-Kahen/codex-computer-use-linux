...
class FocusLeaseTests(TestCase):
    ...
    def test_begin_publishes_prepared_journal_under_lease_registry_and_claim_locks(self) -> None:
        ...
        self.assertEqual(prepared_order[1], coordination.CLAIMS_DIR / "registry.lock")
    ...
    def test_prepared_journal_publish_failure_rolls_back_existing_claim(self) -> None:
        ...
        claim_path = coordination.CLAIMS_DIR / f"{key}.json"
    ...
    def test_begin_rejects_session_change_across_initial_snapshot(self) -> None:
        ...
        self.assertFalse(any(coordination.CLAIMS_DIR.glob("*.json")))
        self.assertFalse(self.lease_file.exists())
        activate.assert_not_called()
