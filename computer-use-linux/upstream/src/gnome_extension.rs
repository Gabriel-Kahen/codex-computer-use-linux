...
mod tests {
    ...
    #[test]
    fn enabled_extensions_contains_uuid_matches_only_the_quoted_entry() {
    ...
    #[test]
    fn setup_requires_shell_reload_for_changed_active_extension() {
    ...
    #[test]
    fn rendered_extension_exposes_guarded_screenshot_capture() {
        let rendered = render_extension_asset(EXTENSION_JS);
