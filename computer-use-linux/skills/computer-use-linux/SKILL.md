...
5. Keep claim and lease tokens private to their owning task. Follow the applicable validation, renewal, recovery, and cleanup sequence exactly. Hyprland companion and generic claim tools share the same version-2 ownership state.
