...
Codex Computer Use on Linux is an independently maintained desktop plugin project for
stock Codex. This policy covers vulnerabilities in this repository's modifications,
...
and the latest release of this project. Older releases might not receive
backports. Users should reproduce an issue on the latest available version when
it is safe to do so.

## Reporting a vulnerability

Do not disclose a suspected vulnerability in a public pull request
...
these desktop integrations, report it through the
[OpenAI Codex security policy](https://github.com/openai/codex/security/policy).
If it also affects these plugins, send a private report here as well so mitigation
